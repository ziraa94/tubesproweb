...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $query_fetch = "SELECT * FROM transaksi WHERE id = '$transaction_id' AND user_email = '$user_email'";
...
if (isset($_POST['update_transaksi'])) {
    ...
    $query_update = "
        UPDATE transaksi 
        SET deskripsi='$deskripsi', jumlah='$jumlah', tanggal='$tanggal', tipe='$tipe', kategori='$kategori', akun_sumber='$akun_sumber'
        WHERE id='$id_update' AND user_email='$user_email'
    ";
    ...
    if (mysqli_query($koneksi, $query_update)) {
        ...
        $query_refresh = "SELECT * FROM transaksi WHERE id = '$id_update' AND user_email = '$user_email'";
            ...
            <div class="card">
                <form action="edit_transaksi.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="deskripsi" name="deskripsi" value="<?= htmlspecialchars($transaction_data['deskripsi']) ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipe" name="tipe" required>
                            <option value="pemasukan" <?= ($transaction_data['tipe'] == 'pemasukan') ? 'selected' : '' ?>>Pemasukan</option>
                            <option value="pengeluaran" <?= ($transaction_data['tipe'] == 'pengeluaran') ? 'selected' : '' ?>>Pengeluaran</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="akun_sumber" name="akun_sumber" required>
                            <option value="bank" <?= ($transaction_data['akun_sumber'] == 'bank') ? 'selected' : '' ?>>Bank BCA</option>
                            <option value="cash" <?= ($transaction_data['akun_sumber'] == 'cash') ? 'selected' : '' ?>>Uang Tunai</option>
                        </select>
                    </div>
