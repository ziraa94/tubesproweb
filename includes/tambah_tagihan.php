  ...
  <main class="main-content">
    <div class="card">
      ...
      <form class="bill-form">
        <input type="text" placeholder="Nama Tagihan (misal: Pulsa Telkomsel)" required>
        <input type="number" placeholder="Jumlah Tagihan (Rp)" required>
        <label for="due-date" style="font-size: 0.9em; font-weight: 600; margin-top: 5px; color: var(--dark);">Tanggal Jatuh Tempo:</label>
        ...
        <button><i class="fas fa-save"></i> Simpan Tagihan</button>
      </form>
    </div>
  </main>
