...
<html lang="id">
  ...
  <body>
    ...
    <header class="header">
      ...
      <a href="register.php" class="btn btn-primary">Masuk</a>
    </header>
    ...
    <main class="main-content">
      <section id="hero" class="hero">
        <div class="hero-text animated">
          ...
          <p>
            FINWISE membantumu mencatat pengeluaran, menabung otomatis, dan
            mewujudkan impian finansialmu — semua dalam satu aplikasi yang
      ...
      <section id="features" class="section">
        ...
        <p class="section-subtitle animated delay-1">
          Dibuat untuk kamu yang ingin mandiri secara finansial, tanpa jargon
          ribet dan spreadsheet membosankan.
        </p>
        ...
        <div class="features">
          <div class="feature-card animated delay-2">
            ...
            <p>
              Masukkan pengeluaran hanya dalam 3 detik — lewat suara, foto, atau
              ketik. Kami mengenali kategori otomatis!
            </p>
          </div>
          <div class="feature-card animated delay-3">
            ...
            <p>
              Tentukan tujuan (liburan, DP motor, dll), lalu kami sisihkan
              uangmu tiap kali kamu gajian — tanpa kamu sadari!
            </p>
          </div>
          <div class="feature-card animated delay-3">
            ...
            <p>
              Laporan mingguan dengan visualisasi menyenangkan — kamu jadi paham
              ke mana uangmu mengalir.
            </p>
          </div>
        </div>
      </section>
    ...
    <footer class="footer">
      <div class="footer-content">
        <div class="footer-column">
          ...
          <p style="color: #cbd5e1; line-height: 1.6">
            Platform keuangan pribadi yang membantumu hidup lebih tenang, bijak,
            dan bahagia — tanpa khawatir soal uang.
          </p>
        </div>
        <div class="footer-column">
          <h3>Link Cepat</h3>
          <ul class="footer-links">
            <li>
              <a href="#hero"><i class="fas fa-chevron-right"></i> Beranda</a>
            </li>
            <li>
              <a href="#features"
                ><i class="fas fa-chevron-right"></i> Fitur Unggulan</a
              >
            </li>
          </ul>
        </div>
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li>
              <a href="#"><i class="fas fa-chevron-right"></i> Pusat Bantuan</a>
            </li>
            <li>
            ...
            <li>
              <a href="#"
                ><i class="fas fa-chevron-right"></i> Privasi & Keamanan</a
              >
            </li>
            <li>
              <a href="#"><i class="fas fa-chevron-right"></i> Hubungi Kami</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="footer-bottom">
        ...
        <p>
          By Kelompok FINWISE mata kuliah ProWeb
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        document
          .querySelectorAll(
            ".feature-card, .section-title, .section-subtitle, .mockup-title"
          )
          .forEach((el) => {
            observer.observe(el);
          });
