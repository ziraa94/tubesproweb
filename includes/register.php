...
if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        mysqli_query($koneksi, "INSERT INTO data_masuk VALUES ('', '$nama', '$email', '$password_hash')");
...
<div class="login-container">
  ...
  <form method="POST">
    ...
    <div class="input-group">
      ...
      <input type="nama" name="nama" class="login-input" placeholder="Nama Lengkap" required>
    </div>
