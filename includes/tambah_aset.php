...
<head>
  ...
  <title>Tambah Aset - FINWISE</title>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .asset-form input, .asset-form select {
        padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 1em; background-color: #fafafa;
    }
    .asset-form button { 
    ...
    .asset-form button:hover { background-color: #6f809f; }
  </style>
</head>
<body>
  ...
  <main class="main-content">
    <div class="card">
      ...
      <form class="asset-form" method="POST" action="proses_tambah_aset.php">
