  ...
  <main class="main-content">
    <div class="card">
      ...
      <div class="input-group">
        ...
        <input type="text" id="goal-name" name="goal-name" placeholder="Contoh: Dana Liburan ke Bali" required>
      </div>

      <div class="input-group">
        <label for="target-amount">Nominal Target Tabungan (Rp)</label>
        <input type="number" id="target-amount" name="target-amount" placeholder="Contoh: 15000000" min="1000" required>
      </div>

      <div class="input-group">
        <label for="current-amount">Nominal Awal Ditabung (Rp)</label>
        <input type="number" id="current-amount" name="current-amount" placeholder="Contoh: 5000000" value="0" min="0" required>
      </div>
