...
<head>
  ...
  <title>Tambah Tabungan dan Target - FINWISE</title>
...
<body>
  ...
  <main class="main-content">
    <div class="card">
      <div class="card-title"><i class="fas fa-piggy-bank" style="margin-right: 10px; color: var(--primary);"></i> Target Tabungan Baru</div>
    <form class="transaction-form" action="proses_tambah_tabungan.php" method="POST">
      
      <div class="input-group">
        <label for="goal-name">Nama Target Tabungan</label>
        <input type="text" name="nama_target" placeholder="Contoh: Dana Liburan ke Bali" required>
      </div>

      <div class="input-group">
        <label for="target-amount">Nominal Target Tabungan (Rp)</label>
        <input type="number" name="target_nominal" placeholder="Contoh: 15000000" min="1000" required>
      </div>

      <div class="input-group">
        <label for="current-amount">Nominal Awal Ditabung (Rp)</label>
        <input type="number" name="saldo_awal" placeholder="Contoh: 5000000" value="0" min="0" required>
      </div>

      <div class="input-group">
        <label for="target-date">Tanggal Target Tercapai</label>
        <input type="date"  name="tanggal_target" required>
      </div>
      
      <button type="submit" class="btn-submit">
        <i class="fas fa-bullseye"></i> Simpan Target Baru
      </button>
    </form>
    </div>
  </main>
